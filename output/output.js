...
var Table = React.createClass({displayName: "Table",
        getInitialState: function() {
          return {headers: ["Class", "Final Date", "Grade"], body: [["Science", "10/13/98", "B-"], ["Math", "10/15/98", "C+"], ["Computer Science", "10/8/98", "D"]]};
        },
        ...
        render: function() {
          var createItem = function(itemText) {
            return React.createElement("td", null, itemText);
          };

          var createRow = function(row) {
            return React.createElement("tr", null, " ", row.map(createItem), " ")
          }
